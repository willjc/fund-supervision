...
public class SupervisionAccountLogServiceImpl implements ISupervisionAccountLogService
{
    ...
    {
        return supervisionAccountLogMapper.selectTransferRecordList(params);
    }
     ...
     */
    @Override
    public BigDecimal calculateSupervisionBalance(Long institutionId)
    {
        return supervisionAccountLogMapper.calculateSupervisionBalance(institutionId);
    }
     ...
     */
    @Override
    public BigDecimal calculatePrepaidBalance(Long institutionId)
    {
        return supervisionAccountLogMapper.calculatePrepaidBalance(institutionId);
    }
     ...
     */
    @Override
    public BigDecimal calculateDepositBalance(Long institutionId)
    {
        return supervisionAccountLogMapper.calculateDepositBalance(institutionId);
    }
    ...
    {
        return supervisionAccountLogMapper.selectInstitutionAccountList(params);
    }
