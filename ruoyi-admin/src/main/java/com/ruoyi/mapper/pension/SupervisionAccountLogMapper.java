...
public interface SupervisionAccountLogMapper
{
     ...
     * @return 监管账户余额
     */
    public java.math.BigDecimal calculateSupervisionBalance(@Param("institutionId") Long institutionId);
     ...
     * @return 预收费余额
     */
    public java.math.BigDecimal calculatePrepaidBalance(@Param("institutionId") Long institutionId);
     ...
     * @return 押金余额
     */
    public java.math.BigDecimal calculateDepositBalance(@Param("institutionId") Long institutionId);
     ...
     * @return 机构账户列表
     */
    public List<Map<String, Object>> selectInstitutionAccountList(@Param("params") Map<String, Object> params);
