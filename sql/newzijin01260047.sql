...
INSERT INTO `account_info` VALUES ('27', '42', '30', 'ACC1769354296361306', '账户-42', '1', '12800.00', '9800.00', '2000.00', '1000.00', '', '2026-01-25 23:18:16', '', '2026-01-26 00:35:14', '老人入住时自动创建 | 支付订单ORD1769354296366增加余额11400.00元 | 支付订单ORD1769354699641增加余额1400.00元 | 线下支付订单ORD1769358875267增加余额700.00元');
...
CREATE TABLE `expense_record` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=76 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='璐圭敤璁板綍琛';
...
INSERT INTO `expense_record` VALUES ('75', '42', '27', 'service', 'income', '700.00', '订单支付：续费订单-服务费预存', '67', 'order_info', '12100.00', '12800.00', 'system', '2026-01-26 00:35:14', '', null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单主表';

-- ----------------------------
-- Records of order_info
-- ----------------------------
INSERT INTO `order_info` VALUES ('64', 'ORD1769354296366', '1', '42', '119', '30', null, '59', '11400.00', '11400.00', '0.00', '11400.00', '1', '支付宝', '2026-01-25 23:20:20', '2026-01-25', '2026-01-25', '2027-01-25', '月度', '12', null, '', 'jg696562', '2026-01-25 23:18:16', '', '2026-01-25 23:20:20', null, null);
INSERT INTO `order_info` VALUES ('65', 'ORD1769354699641', '2', '42', '119', '30', null, null, '1400.00', '1400.00', '0.00', '1400.00', '1', '支付宝', '2026-01-25 23:34:24', '2026-01-25', '2027-01-25', '2027-03-25', '月度', '2', null, null, 'jg696562', '2026-01-25 23:25:00', '', '2026-01-25 23:34:24', null, null);
INSERT INTO `order_info` VALUES ('66', 'ORD1769357208136', '2', '42', '119', '30', null, null, '700.00', '700.00', '0.00', '700.00', '1', 'cash', '2026-01-26 00:25:48', '2026-01-26', '2027-01-25', '2027-02-25', '月度', '1', null, null, 'jg696562', '2026-01-26 00:06:48', '', '2026-01-26 00:25:48', 'http://localhost:8080/profile/upload/2026/01/26/750263_20260126002545A001.png', '');
INSERT INTO `order_info` VALUES ('67', 'ORD1769358875267', '2', '42', '119', '30', null, null, '700.00', '700.00', '0.00', '700.00', '1', 'cash', '2026-01-26 00:35:14', '2026-01-26', '2027-01-25', '2027-02-25', '月度', '1', null, null, 'jg696562', '2026-01-26 00:34:35', '', '2026-01-26 00:35:14', 'http://localhost:8080/profile/upload/2026/01/26/QP61014284_20260126003500A001.jpg', '');
...
CREATE TABLE `order_item` (
  ...
  PRIMARY KEY (`item_id`),
  KEY `idx_order_id` (`order_id`)
) ENGINE=InnoDB AUTO_INCREMENT=215 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='订单明细表';
...
INSERT INTO `order_item` VALUES ('211', '66', 'ORD1769357208136', '床位费', 'bed_fee', '床位费1个月', '300.00', null, '0', '1', '300.00', '1个月', 'jg696562', '2026-01-26 00:06:48', '', null, null);
INSERT INTO `order_item` VALUES ('212', '66', 'ORD1769357208136', '护理费', 'care_fee', '护理费1个月', '400.00', null, '0', '1', '400.00', '1个月', 'jg696562', '2026-01-26 00:06:48', '', null, null);
INSERT INTO `order_item` VALUES ('213', '67', 'ORD1769358875267', '床位费', 'bed_fee', '床位费1个月', '300.00', null, '0', '1', '300.00', '1个月', 'jg696562', '2026-01-26 00:34:35', '', null, null);
INSERT INTO `order_item` VALUES ('214', '67', 'ORD1769358875267', '护理费', 'care_fee', '护理费1个月', '400.00', null, '0', '1', '400.00', '1个月', 'jg696562', '2026-01-26 00:34:35', '', null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='支付记录表';

-- ----------------------------
-- Records of payment_record
-- ----------------------------
INSERT INTO `payment_record` VALUES ('21', 'PAY1769354418932162', '64', '42', '30', '11400.00', '支付宝', '0', '2026-01-25 23:20:20', 'PAY1769354418932162', null, '120', null, '', '2026-01-25 23:20:20', '', null, null, null);
INSERT INTO `payment_record` VALUES ('22', 'PAY1769355263081707', '65', '42', '30', '1400.00', '支付宝', '0', '2026-01-25 23:34:24', 'PAY1769355263081707', null, '120', null, '', '2026-01-25 23:34:24', '', null, null, null);
INSERT INTO `payment_record` VALUES ('23', 'PAY1769358348170', '66', '42', '30', '700.00', 'cash', '1', '2026-01-26 00:25:48', 'OFFLINE1769358348170', '线下支付', 'admin', null, '', '2026-01-26 00:25:48', '', null, 'http://localhost:8080/profile/upload/2026/01/26/750263_20260126002545A001.png', '');
INSERT INTO `payment_record` VALUES ('24', 'PAY1769358913827', '67', '42', '30', '700.00', 'cash', '1', '2026-01-26 00:35:14', 'OFFLINE1769358913827', '线下支付', 'admin', null, '', '2026-01-26 00:35:14', '', null, 'http://localhost:8080/profile/upload/2026/01/26/QP61014284_20260126003500A001.jpg', '');
...
) ENGINE=InnoDB AUTO_INCREMENT=1158 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='字典数据表';
...
INSERT INTO `sys_dict_data` VALUES ('300', '0', '床位费', 'bed_fee', 'item_type', '', 'primary', 'N', '0', 'admin', '2025-10-28 20:01:58', '', null, '床位使用费用');
INSERT INTO `sys_dict_data` VALUES ('301', '0', '护理费', 'care_fee', 'item_type', '', 'success', 'N', '0', 'admin', '2025-10-28 20:01:58', '', null, '护理服务费用');
INSERT INTO `sys_dict_data` VALUES ('302', '0', '餐饮费', 'food_fee', 'item_type', '', 'warning', 'N', '0', 'admin', '2025-10-28 20:01:58', '', null, '餐饮服务费用');
INSERT INTO `sys_dict_data` VALUES ('303', '0', '医疗费', 'medical_fee', 'item_type', '', 'danger', 'N', '0', 'admin', '2025-10-28 20:01:58', '', null, '医疗服务费用');
INSERT INTO `sys_dict_data` VALUES ('304', '0', '其他费用', 'other_fee', 'item_type', '', 'info', 'N', '0', 'admin', '2025-10-28 20:01:58', '', null, '其他杂项费用');
...
INSERT INTO `sys_dict_data` VALUES ('1154', '1', '入驻费', '1', 'order_type', '', 'primary', 'N', '0', 'admin', '2026-01-25 23:51:45', 'admin', '2026-01-25 23:51:45', '新入驻订单');
INSERT INTO `sys_dict_data` VALUES ('1155', '2', '续费费', '2', 'order_type', '', 'success', 'N', '0', 'admin', '2026-01-25 23:51:45', 'admin', '2026-01-25 23:51:45', '续费订单');
INSERT INTO `sys_dict_data` VALUES ('1156', '6', '押金', 'deposit', 'item_type', '', 'warning', 'N', '0', 'admin', '2026-01-26 00:06:23', 'admin', '2026-01-26 00:06:23', '入驻押金');
INSERT INTO `sys_dict_data` VALUES ('1157', '7', '会员费', 'member_fee', 'item_type', '', 'info', 'N', '0', 'admin', '2026-01-26 00:06:23', 'admin', '2026-01-26 00:06:23', '会员服务费');
...
) ENGINE=InnoDB AUTO_INCREMENT=413 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='字典类型表';
...
INSERT INTO `sys_dict_type` VALUES ('412', '项目类型', 'item_type', '0', 'admin', '2026-01-25 23:51:11', 'admin', '2026-01-25 23:51:11', '订单明细项目类型字典类型');
...
) ENGINE=InnoDB AUTO_INCREMENT=548 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
...
INSERT INTO `sys_logininfor` VALUES ('536', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-25 23:59:23');
INSERT INTO `sys_logininfor` VALUES ('537', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-25 23:59:29');
INSERT INTO `sys_logininfor` VALUES ('538', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-25 23:59:54');
INSERT INTO `sys_logininfor` VALUES ('539', 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-25 23:59:56');
INSERT INTO `sys_logininfor` VALUES ('540', 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-26 00:04:48');
INSERT INTO `sys_logininfor` VALUES ('541', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-26 00:04:54');
INSERT INTO `sys_logininfor` VALUES ('542', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-26 00:20:43');
INSERT INTO `sys_logininfor` VALUES ('543', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-26 00:20:49');
INSERT INTO `sys_logininfor` VALUES ('544', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-26 00:25:30');
INSERT INTO `sys_logininfor` VALUES ('545', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-26 00:25:35');
INSERT INTO `sys_logininfor` VALUES ('546', 'jg696562', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '退出成功', '2026-01-26 00:35:52');
INSERT INTO `sys_logininfor` VALUES ('547', 'admin', '127.0.0.1', '内网IP', 'Chrome 14', 'Windows 10', '0', '登录成功', '2026-01-26 00:35:55');
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5008 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单权限表';
...
INSERT INTO `sys_menu` VALUES ('5007', '线下支付', '2041', '6', '', null, null, '', '1', '0', 'F', '0', '0', 'order:info:offlinePay', '#', 'admin', '2026-01-26 00:10:39', 'admin', '2026-01-26 00:10:39', '订单线下支付按钮');
...
) ENGINE=InnoDB AUTO_INCREMENT=582 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志记录';
...
INSERT INTO `sys_oper_log` VALUES ('578', '入住人续费', '1', 'com.ruoyi.web.controller.PensionResidentController.renew()', 'POST', '1', 'jg696562', null, '/pension/resident/renew', '127.0.0.1', '内网IP', '{\"depositAmount\":0,\"elderId\":42,\"finalAmount\":700,\"memberFee\":0,\"monthCount\":1,\"paymentMethod\":\"online\"}', '{\"msg\":\"操作成功\",\"code\":200}', '0', null, '2026-01-26 00:06:48', '34');
INSERT INTO `sys_oper_log` VALUES ('579', '线下支付订单', '2', 'com.ruoyi.web.controller.OrderInfoController.offlinePay()', 'PUT', '1', 'jg696562', null, '/order/info/offlinePay/66', '127.0.0.1', '内网IP', '66 {\"params\":{},\"paymentMethod\":\"cash\",\"paymentProof\":\"http://localhost:8080/profile/upload/2026/01/26/750263_20260126002545A001.png\",\"paymentProofRemark\":\"\",\"unpaidAmount\":0}', '{\"msg\":\"操作成功\",\"code\":200}', '0', null, '2026-01-26 00:25:48', '32');
INSERT INTO `sys_oper_log` VALUES ('580', '入住人续费', '1', 'com.ruoyi.web.controller.PensionResidentController.renew()', 'POST', '1', 'jg696562', null, '/pension/resident/renew', '127.0.0.1', '内网IP', '{\"depositAmount\":0,\"elderId\":42,\"finalAmount\":700,\"memberFee\":0,\"monthCount\":1,\"paymentMethod\":\"online\"}', '{\"msg\":\"操作成功\",\"code\":200}', '0', null, '2026-01-26 00:34:35', '44');
INSERT INTO `sys_oper_log` VALUES ('581', '线下支付订单', '2', 'com.ruoyi.web.controller.OrderInfoController.offlinePay()', 'PUT', '1', 'jg696562', null, '/order/info/offlinePay/67', '127.0.0.1', '内网IP', '67 {\"params\":{},\"paymentMethod\":\"cash\",\"paymentProof\":\"http://localhost:8080/profile/upload/2026/01/26/QP61014284_20260126003500A001.jpg\",\"paymentProofRemark\":\"\",\"unpaidAmount\":0}', '{\"msg\":\"操作成功\",\"code\":200}', '0', null, '2026-01-26 00:35:13', '48');
...
INSERT INTO `sys_user` VALUES ('119', null, 'jg696562', '郑州兴福养老集团-程星', null, '00', '1', '', '15623696562', '0', '', '$2a$10$LdL9BDVJJHuMUol4oiy2qu3JCXtyrZ4hY9CI66PFz9OwzVjnR6LK2', '0', '0', '127.0.0.1', '2026-01-26 00:25:36', null, 'admin', '2026-01-25 19:16:59', '', null, null);
