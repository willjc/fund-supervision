...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='床位分配记录表';
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='床位信息表';

-- ----------------------------
-- Records of bed_info
-- ----------------------------
INSERT INTO `bed_info` VALUES ('1', '16', '12', '1', '1', '0', '2000.00', '2', '20.00', 'Y', 'Y', '12', '', '2025-11-11 03:04:24', '', null, null);
...
CREATE TABLE `deposit_apply` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='押金使用申请表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='老人基础信息表';
...
INSERT INTO `pension_institution` VALUES ('20', 'admin第二个机构', '91410100MA45TE2X84', '100.00', 'admin第二个机构', 'admin第二个机构', 'admin第二个机构', null, 'ASDF', '18539279011', null, null, 'nursing_home', '500', '200-5000', null, null, null, '2025-11-02', null, 'ASDF ', '412829198908160071', 'admin第二个机构ASDF ', '18539279011', '789789', '100.00', '564564', '45456', '4', null, null, null, null, '0', '', '2025-11-11 00:49:16', '', null, null, null, null);
...
) ENGINE=InnoDB AUTO_INCREMENT=213 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
...
INSERT INTO `sys_menu` VALUES ('2032', '查增入住', '2030', '2', 'checkin', 'pension/elder/checkin', null, null, '1', '0', 'C', '0', '0', 'pension:elder:checkin', 'edit', 'admin', '2025-11-03 16:03:36', '', null, '');
...
) ENGINE=InnoDB AUTO_INCREMENT=210 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '超管', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-11-11 03:16:54', '2025-10-28 02:47:08', 'admin', '2025-10-28 02:47:08', '', '2025-11-10 03:01:33', '管理员');
...
INSERT INTO `sys_user` VALUES ('100', '103', 'supervision', '民政监管员', '00', 'supervision@qq.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE/TP57rDdaTpe', '0', '2', '127.0.0.1', '2025-10-29 04:49:09', null, 'admin', '2025-10-29 04:49:09', '', null, '民政监管测试账号，密码：admin123');
