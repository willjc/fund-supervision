-- ===================================================================
-- pension_institution表结构变更
-- 添加筛选功能所需的新字段
-- ===================================================================

-- 1. 添加区县代码字段(关联字典)
ALTER TABLE pension_institution
ADD COLUMN district_code VARCHAR(50) COMMENT '区县代码(关联pension_district字典)' AFTER district;
...
-- 9. 更新现有数据的district_code(根据district字段映射)
UPDATE pension_institution SET district_code = '410105' WHERE district LIKE '%金水%';
UPDATE pension_institution SET district_code = '410103' WHERE district LIKE '%二七%';
UPDATE pension_institution SET district_code = '410102' WHERE district LIKE '%中原%';
UPDATE pension_institution SET district_code = '410104' WHERE district LIKE '%管城%';
UPDATE pension_institution SET district_code = '410108' WHERE district LIKE '%惠济%';
UPDATE pension_institution SET district_code = '410106' WHERE district LIKE '%上街%';
