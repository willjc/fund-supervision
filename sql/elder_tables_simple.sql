...
-- 3. 老人入住申请表
CREATE TABLE IF NOT EXISTS `elder_check_in` (
...
-- 添加字典类型
INSERT IGNORE INTO `sys_dict_type` VALUES (200, '护理等级', 'elder_care_level', '0', 'admin', NOW(), 'ry', NOW(), '老人护理等级字典类型');
INSERT IGNORE INTO `sys_dict_type` VALUES (201, '老人状态', 'elder_status', '0', 'admin', NOW(), 'ry', NOW(), '老人状态字典类型');
INSERT IGNORE INTO `sys_dict_type` VALUES (202, '床位类型', 'bed_type', '0', 'admin', NOW(), 'ry', NOW(), '床位类型字典类型');
INSERT IGNORE INTO `sys_dict_type` VALUES (203, '床位状态', 'bed_status', '0', 'admin', NOW(), 'ry', NOW(), '床位状态字典类型');
INSERT IGNORE INTO `sys_dict_type` VALUES (204, '入住申请状态', 'check_in_status', '0', 'admin', NOW(), 'ry', NOW(), '入住申请状态字典类型');
INSERT IGNORE INTO `sys_dict_type` VALUES (205, '分配状态', 'allocation_status', '0', 'admin', NOW(), 'ry', NOW(), '床位分配状态字典类型');
INSERT IGNORE INTO `sys_dict_type` VALUES (206, '押金状态', 'deposit_status', '0', 'admin', NOW(), 'ry', NOW(), '押金状态字典类型');
...
(200, '自理', '1', 'elder_care_level', '', 'primary', 'N', '0', 'admin', NOW(), '生活完全自理'),
(201, '半护理', '2', 'elder_care_level', '', 'warning', 'N', '0', 'admin', NOW(), '需要部分护理'),
(202, '全护理', '3', 'elder_care_level', '', 'danger', 'N', '0', 'admin', NOW(), '需要全面护理'),
(203, '未入住', '0', 'elder_status', '', 'info', 'N', '0', 'admin', NOW(), '尚未入住'),
(204, '已入住', '1', 'elder_status', '', 'success', 'N', '0', 'admin', NOW(), '已入住'),
(205, '已退住', '2', 'elder_status', '', 'danger', 'N', '0', 'admin', NOW(), '已退住'),
(206, '普通床位', '1', 'bed_type', '', 'primary', 'N', '0', 'admin', NOW(), '标准普通床位'),
(207, '豪华床位', '2', 'bed_type', '', 'warning', 'N', '0', 'admin', NOW(), '豪华舒适床位'),
(208, '医疗床位', '3', 'bed_type', '', 'danger', 'N', '0', 'admin', NOW(), '医疗护理床位'),
(209, '空置', '0', 'bed_status', '', 'success', 'N', '0', 'admin', NOW(), '床位空置可用'),
(210, '占用', '1', 'bed_status', '', 'danger', 'N', '0', 'admin', NOW(), '床位已被占用'),
(211, '维修', '2', 'bed_status', '', 'warning', 'N', '0', 'admin', NOW(), '床位维修中'),
(212, '申请中', '0', 'check_in_status', '', 'primary', 'N', '0', 'admin', NOW(), '入住申请处理中'),
(213, '已入住', '1', 'check_in_status', '', 'success', 'N', '0', 'admin', NOW(), '已成功入住'),
(214, '已拒绝', '2', 'check_in_status', '', 'danger', 'N', '0', 'admin', NOW(), '申请被拒绝'),
(215, '已取消', '3', 'check_in_status', '', 'info', 'N', '0', 'admin', NOW(), '申请已取消'),
(216, '在住', '1', 'allocation_status', '', 'success', 'N', '0', 'admin', NOW(), '老人在住'),
(217, '已退住', '2', 'allocation_status', '', 'danger', 'N', '0', 'admin', NOW(), '老人已退住'),
(218, '未支付', '0', 'deposit_status', '', 'danger', 'N', '0', 'admin', NOW(), '押金未支付'),
(219, '已支付', '1', 'deposit_status', '', 'success', 'N', '0', 'admin', NOW(), '押金已支付'),
(220, '已退还', '2', 'deposit_status', '', 'info', 'N', '0', 'admin', NOW(), '押金已退还');

-- 初始化床位数据
INSERT IGNORE INTO `bed_info` (`institution_id`, `room_number`, `bed_number`, `bed_type`, `bed_status`, `price`, `floor_number`, `room_area`, `has_bathroom`, `has_balcony`, `facilities`, `create_by`, `create_time`) VALUES
(1, '101', '01', '1', '0', 2000.00, 1, 20.00, '1', '0', '空调、电视、热水器', 'admin', NOW()),
(1, '101', '02', '1', '0', 2000.00, 1, 20.00, '1', '0', '空调、电视、热水器', 'admin', NOW()),
(1, '102', '01', '2', '0', 3500.00, 1, 25.00, '1', '1', '空调、电视、热水器、阳台、独立卫浴', 'admin', NOW()),
(1, '102', '02', '2', '0', 3500.00, 1, 25.00, '1', '1', '空调、电视、热水器、阳台、独立卫浴', 'admin', NOW()),
(1, '201', '01', '3', '0', 5000.00, 2, 30.00, '1', '1', '医疗床、呼吸机、心电监护、独立卫浴', 'admin', NOW()),
(1, '201', '02', '3', '1', 5000.00, 2, 30.00, '1', '1', '医疗床、呼吸机、心电监护、独立卫浴', 'admin', NOW());