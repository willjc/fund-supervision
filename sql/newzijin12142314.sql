...
INSERT INTO `account_info` VALUES ('17', '35', '2', 'ACC1765645755651966', '账户-35', '1', '13300.00', '6650.00', '5320.00', '1330.00', '', '2025-12-14 01:09:16', '', '2025-12-14 01:09:19', '老人入住时自动创建 | 支付订单ORD1765645755656增加余额13300.00元');
...
) ENGINE=InnoDB AUTO_INCREMENT=312 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统访问记录';
...
CREATE TABLE `sys_menu` (
  ...
  PRIMARY KEY (`menu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4059 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='菜单权限表';
...
) ENGINE=InnoDB AUTO_INCREMENT=394 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='操作日志记录';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '超管', '00', '1', 'ry@163.com', '15888888888', '1', '/profile/avatar/2025/11/11/1eff83cb59164ef080c26356af4d7a54.png', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2025-12-14 21:54:43', '2025-10-28 02:47:08', 'admin', '2025-10-28 02:47:08', '', '2025-11-11 23:51:01', '管理员');
...
INSERT INTO `sys_user` VALUES ('101', null, 'jigouuser', '机构测试员', '00', '1', '', '', '0', '', '$2a$10$xNzJB66SbFN9kTTqpZgkb..0Z.8Ex3TmjC1Yszvr5TtrDoCxL7YH6', '0', '0', '127.0.0.1', '2025-12-14 22:35:13', null, 'admin', '2025-11-10 02:23:12', '', null, null);
