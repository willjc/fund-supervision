...
-- 检查现有机构ID
SELECT institution_id, institution_name FROM pension_institution LIMIT 3;
...
('张大爷', '1', '110101192001011234', '1920-01-01', 104, '13900139001', '北京市朝阳区某某小区1号楼', '张儿子', '13900139001', '身体状况良好，有轻微高血压', '3', '1', '身体健康状况良好，需要定期测量血压'),
('李奶奶', '2', '110101192502022345', '1925-02-02', 99, '13900139002', '北京市西城区某某小区2号楼', '李女儿', '13900139002', '需要半护理，行动不便', '2', '1', '需要半护理，行动不便，需要轮椅辅助'),
('王爷爷', '1', '110101193003033456', '1930-03-03', 94, '13900139003', '北京市东城区某某小区3号楼', '王孙子', '13900139003', '需要全护理，失能状态', '3', '1', '需要全护理，失能状态，需要24小时照护');
...
('WAR001', 2, 2, 1, '3', 13700.00, 4, 2800.00, '账户余额偏低，仅够使用4个月', '建议联系家属适时充值，避免影响服务', '0', '余额严重预警提示'),
('WAR002', 1, 1, 1, '2', 22000.00, 7, 3000.00, '账户余额适中，可使用7个月', '建议关注账户余额变化，适时提醒家属', '0', '余额警告提醒'),
('WAR003', 3, 3, 1, '1', 17000.00, 4, 3500.00, '账户余额一般，可使用4个月', '建议适时关注余额情况，做好充值准备', '0', '余额提示信息');
