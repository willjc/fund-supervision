      ...
      <el-row :gutter="20">
        <el-col :span="8" v-if="currentInstitution.businessLicense">
          <el-card shadow="hover">
            ...
            <el-image
              :src="currentInstitution.businessLicense"
              style="width: 100%; height: 200px;"
              fit="contain"
              :preview-src-list="[currentInstitution.businessLicense]"
            ></el-image>
          </el-card>
        </el-col>
        <el-col :span="8" v-if="currentInstitution.approvalCertificate">
          <el-card shadow="hover">
            ...
            <el-image
              :src="currentInstitution.approvalCertificate"
              style="width: 100%; height: 200px;"
              fit="contain"
              :preview-src-list="[currentInstitution.approvalCertificate]"
            ></el-image>
          </el-card>
        </el-col>
        <el-col :span="8" v-if="currentInstitution.supervisionAgreement">
          <el-card shadow="hover">
            ...
            <el-image
              :src="currentInstitution.supervisionAgreement"
              style="width: 100%; height: 200px;"
              fit="contain"
              :preview-src-list="[currentInstitution.supervisionAgreement]"
            ></el-image>
          </el-card>
        </el-col>
      </el-row>
