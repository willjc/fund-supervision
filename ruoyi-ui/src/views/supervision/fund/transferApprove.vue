  ...
  <div class="app-container">
    <el-card>
      ...
      <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
        ...
        <el-form-item label="申请状态" prop="applyStatus">
          <el-select v-model="queryParams.applyStatus" placeholder="请选择状态" clearable size="small">
            ...
            <el-option label="已划拨" value="approved" />
            <el-option label="已拒绝" value="rejected" />
            <el-option label="已完成" value="completed" />
          </el-select>
        </el-form-item>
        <el-form-item label="养老机构" prop="institutionId">
          <el-select v-model="queryParams.institutionId" placeholder="请选择机构" clearable filterable size="small">
            <el-option
      ...
      <el-table v-loading="loading" :data="applyList" border>
        ...
        <el-table-column label="养老机构" prop="institutionName" width="150" show-overflow-tooltip />
        ...
        <el-table-column label="申请状态" prop="applyStatus" width="130" align="center">
          <template slot-scope="scope">
            <el-tag :type="getStatusType(scope.row.applyStatus)">
              {{ getStatusLabel(scope.row.applyStatus) }}
            </el-tag>
          </template>
        </el-table-column>
    ...
    <el-dialog title="申请详情" :visible.sync="detailOpen" width="700px" append-to-body>
      <el-descriptions v-if="detailData" :column="2" border>
        ...
        <el-descriptions-item label="养老机构">{{ detailData.institutionName || '-' }}</el-descriptions-item>
        ...
        <el-descriptions-item label="申请状态">
          <el-tag :type="getStatusType(detailData.applyStatus)">{{ getStatusLabel(detailData.applyStatus) }}</el-tag>
        </el-descriptions-item>
    ...
    <el-dialog title="划拨申请审批" :visible.sync="approveOpen" width="600px" append-to-body>
      <el-form ref="approveForm" :model="approveForm" :rules="approveRules" label-width="120px">
        ...
        <el-form-item label="申请原因">
          <el-input v-model="approveForm.applyReason" type="textarea" :rows="2" disabled />
        </el-form-item>
...
<script>
import { listFundTransferApply, getFundTransferApply, supervisionApprove } from '@/api/pension/fundTransferApply'
import { listAllInstitutions } from '@/api/pension/institution'
...
export default {
  ...
  methods: {
    loadInstitutions() {
      listAllInstitutions().then(response => {
